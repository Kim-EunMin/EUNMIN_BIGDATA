...
NEWS <- NEWS2 # 최종 결과 저장
NEWS
NEWS$news_content                                                                                  #12/11 일꺼 네이버에 제주라고 검색해을때 스크립 한 것이다.
...
wordcloud2( word_table2, minRotation = -pi / 6, maxRotation = -pi / 6, rotateRatio = 1 )             #네이버에서 제주 검색한 걸 대략적인 전처리 후 워드클라우드 작성한 것이다. 그래서 이제 많이 나오는 단어들을 가지고 분석한다. 
                                                                                                     #웹스크래핑은 텍스트마이닝을 하기 위한 작업인것!
© 2019 GitHub, Inc.