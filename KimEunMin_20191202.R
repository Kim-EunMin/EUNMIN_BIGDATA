...
#2019-12-02 (HW5)
#
#문제1) 어떤 학급의 성별이 다음과 같을 때 주어진 문제를 해결하기 위한 R 코드를 작성하시오.
#                                     F F F M M F F F M M
...
#문제2) 좋아하는 계절에 대한 조사 결과가 다음과 같을 때 주어진 문제를 해결하기 위한 R 코드를 작성하시오.
...
barplot(b.new,col="green",main="계절")

#4. season에 있는 값들에 대해 원그래프를 작성하여 출력하시오.
pie(b.new,main="계절",col="Pink")




#문제3) 학생 A의 과목별 성적이 다음과 같을 때 각 문제를 해결하기 위한 R 코드를 작성하시오.
...
hist(score,main="학생 성적", col="purple",las=1)

#문제4) R에서 제공하는 mtcars 데이터셋에 대해 다음 문제를 해결하기 위한 R코드를 작성하시오.
